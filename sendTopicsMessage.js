...
module.exports = async function sendTopicsMessage(chatId = mainChannelId) 
{
    ...
    {
        const button = { text: channel, url: channels[channel] }
    ...
    return await bot.telegram.sendMessage(chatId, "Выберите цену $", { reply_markup: { inline_keyboard } }).catch(err => console.log(err))
}
